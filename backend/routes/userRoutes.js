...
const userRouter = express.Router(); // Configure express Router
const { validateNIN, signup, login, goToUserDashboard, emailOTP, verifyEmailOTP,
  logout } = require("../controllers/userController"); // Import functions from user controller file
const multer = require('multer'); // Import multer library to handle images

// MULTER library configuration for Filenames and storage location set up
